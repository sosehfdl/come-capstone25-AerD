...
load_from = '/mnt/d/py/AIM/Drone_detection/YOLO-World/yolo_world_v2_s_obj365v1_goldg_pretrain-55b943ea.pth'
...
# v3 train, val, test를 det dataset으로 사용 ##################################################
v3_dataset_train = dict(
    # _delete_=True,
    type='MultiModalDataset',
    dataset=dict(
        type='YoloWorldTankBaseDataset',
        data_root='/mnt/d/py/AIM/Drone_detection/dataset/1_1_3',
        ann_file='v3_train.json',
        data_prefix=dict(img='train/'),
...
#     dataset=dict(
#         type='YoloWorldTankBaseDataset',
#         data_root='../../../dataset/1_1_3',
#         ann_file='v3_val.json',
#         data_prefix=dict(img='train/'),
#         filter_cfg=dict(filter_empty_gt=False, min_size=32)),
#     class_text_path='data/tank/tank_json/tank_base_text.json',
#     pipeline=train_pipeline)

# v3_dataset_test = dict(
#     _delete_=True,
#     type='MultiModalDataset',
#     dataset=dict(
#         type='YoloWorldTankBaseDataset',
#         data_root='../../../dataset/1_1_3',
#         ann_file='v3_test.json',
#         data_prefix=dict(img='train/'),
#         filter_cfg=dict(filter_empty_gt=False, min_size=32)),
#     class_text_path='data/tank/tank_json/tank_base_text.json',
#     pipeline=train_pipeline)

# v1, v2, v4 train를 grounding dataset으로 사용 ##################################################


grounding_dataset = dict(
    type='YOLOv5MixedGroundingDataset',
    data_root='/mnt/d/py/AIM/Drone_detection/dataset/grounding',
    ann_file='annotations.json',
    data_prefix=dict(img='dataset_copy/'),
    filter_cfg=dict(filter_empty_gt=True, min_size=32),
    pipeline=train_pipeline)
...
v3_dataset_val = dict(
    ...
    type='MultiModalDataset',
    dataset=dict(
        type='YoloWorldTankNovelDataset',
        data_root='/mnt/d/py/AIM/Drone_detection/dataset/1_1_3',
        ann_file='v3_val.json',
        data_prefix=dict(img='valid/'),
        filter_cfg=dict(filter_empty_gt=True)),
    class_text_path='data/tank/tank_json/tank_novel_text.json',
    pipeline=test_pipeline)

val_dataloader = dict(dataset=v3_dataset_val)
test_dataloader = val_dataloader

# evaluation settings
val_evaluator = dict(type='mmdet.CocoMetric',
                     ann_file='/mnt/d/py/AIM/Drone_detection/dataset/1_1_3/v3_val.json',
                     metric='bbox')
