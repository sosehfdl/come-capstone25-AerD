...
visdrone_train_dataset = dict(
    ...
    type='MultiModalDataset',
    dataset=dict(
        type='YoloWorldVisDroneBaseDataset',
        data_root='data/visdrone',
        ann_file='visdrone_json/train_base.json',
        data_prefix=dict(img='train_images/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='data/visdrone/visdrone_json/visdrone2019_base_text.json',
    pipeline=train_pipeline)
...
visdrone_val_dataset = dict(
    ...
    type='MultiModalDataset',
    dataset=dict(
        type='YoloWorldVisDroneNovelDataset',
        data_root='data/visdrone',
        ann_file='visdrone_json/val_novel.json',
        data_prefix=dict(img='val_images/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='data/visdrone/visdrone_json/visdrone2019_novel_text.json',
    pipeline=test_pipeline)

val_dataloader = dict(dataset=visdrone_val_dataset)
test_dataloader = val_dataloader

# evaluation settings
val_evaluator = dict(type='mmdet.CocoMetric',
                     ann_file='data/visdrone/visdrone_json/val_novel.json',
                     metric='bbox')
