...
train_grounding_dataset = dict(
    type='YOLOv5MixedGroundingDataset',
    data_root='/mnt/d/py/AIM/Projects/Drone_detection/OVD/dataset/grounding',
...
val_evaluator = dict(type='mmdet.CocoMetric',
                     ann_file='/mnt/d/py/AIM/Projects/Drone_detection/OVD/dataset_datamaker/test_dataset/test_modified.json',
                     metric='bbox',
                     classwise=True)
